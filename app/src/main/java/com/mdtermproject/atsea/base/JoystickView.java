...
public class JoystickView extends View implements Runnable {
    ...
    */
     ...
     */
    private static final double RATIO_SIZE_BUTTON = 0.4;

    /**
     * Ratio use to define the size of border (as the distance from the center)
     */
    private static final double RATIO_SIZE_BORDER = 0.6;
    ...
    public JoystickView(Context context, AttributeSet attrs) {
        ...
        buttonColor = Color.argb(127, Color.red(buttonColor), Color.green(buttonColor), Color.blue(buttonColor));
        backgroundColor = Color.argb(127, Color.red(backgroundColor), Color.green(backgroundColor), Color.blue(backgroundColor));
        borderColor = Color.argb(127, Color.red(borderColor), Color.green(borderColor), Color.blue(borderColor));
